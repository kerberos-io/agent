...
RUN [ -f /lib64/ld-linux-x86-64.so.2 ] && $(mkdir -p lib64 && cp /lib64/* lib64/) || echo "nothing to do here x86"
RUN [ -f /lib/ld-linux-aarch64.so.1 ] && $(mkdir -p lib && cp /lib/* lib/) || echo "nothing to do here arm64"
